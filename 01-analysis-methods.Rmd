...
1.	Regression and Correlation/Hypothesis Testing
Using these methods of analysis, we can test the relationship between weather and traffic flows. An initial testing of how weather affects traffic flows into Changi via a visualisation of the regression model could provide us with information on which weather variables best fit 

2.	Multidimensional Scaling (MDS) & Principal Component Analysis
...
In addition, a PCA will be performed on the dataset to determine which variables affect the traffic flow in Changi the most. 
